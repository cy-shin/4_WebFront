...
// 정의되지 않은 함수(num3 is not defined)
// 함수 내에서 선언된 변수여서, 함수 종료 후 사용 불가
...
function typeTest(){
    ...
    console.log(temp1);
    // console.log(temp2); // is not defined
    // console.log(temp3); // is not defined
    ...
    //     return n1 + n2;
    // }
    const fnSum = function(n1, n2) { // 변수명을 함수명으로 사용
        return n1 + n2;
    }
    // 출력 구문에 함수명만 작성한 경우 -> 함수에 작성된 코드 자체가 반환됨
